...
void expectWriteTo(WireMock& wireMock, ::testing::Sequence& s, uint8_t address, std::vector<uint8_t> data)
{
...
void expectReadFrom(WireMock& wireMock, ::testing::Sequence& s, uint8_t address, std::vector<uint8_t> data)
{
