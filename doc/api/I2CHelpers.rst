...
.. glossary::
	...
	WriteToI2C
		...
		:Constructor:	Initiates an I2C transmission to a provided address.

						.. code-block:: cpp

							WriteToI2C(uint8_t address);
		:Destructor:	Calls ``endTransmission()``. Therefore, the transmission will be "opened" for as long
						...
						.. note::
							...
							to forbid it, it may cause problems.

		:write() method: Writes a data using the currently opened transmission.
	...
	ReadFromI2C
		...
		Will try to read the specified number of bytes for 100ms. If the read fails, returns an error value,
